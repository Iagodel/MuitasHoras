...
if [ $stage -le 5 ]; then
  steps/online/nnet2/extract_ivectors_online.sh --cmd "$train_cmd" --nj $nj \
    data/test exp/nnet2_online/extractor exp/nnet2_online/ivectors || exit 1;
fi
...
echo
echo "============== [$TAG] STARTING RUN TDNN NNET3 ============== [$(date)]"
echo

mkdir exp/tri4_nnet
 ./steps/nnet3/train_tdnn.sh data/train data/lang exp/tri3b_ali exp/tri4_nnet
# cp exp/tri4_nnet/final.mdl exp/tri4_nnet/graph/final.mdl

  #python steps/nnet3/train_dnn.py --feat-dir data/train --lang data/lang --ali-dir exp/tri3b_ali --dir exp/tri4_nnet
